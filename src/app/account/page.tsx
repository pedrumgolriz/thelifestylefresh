  ...
  return (
    <div className="mx-auto max-w-3xl px-5 pb-24 pt-20">
      ...
      <div className="invite-card mt-8 p-7">
        ...
        <p className="mt-2 serif text-3xl capitalize tracking-[-0.02em]">
      ...
      <p className="mt-6 text-sm text-ink-soft">
        Posting is within the continental United States. Update the address in Stripe if you
        move within the lower forty-eight or D.C.{" "}
