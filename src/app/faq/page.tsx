...
import { APPLICATIONS_OPEN, FIRST_MAILING, capLineLong, invitationCta } from "@/lib/house";
...
export default async function FaqPage() {
  ...
  const questions = [
    ...
    },
    {
      ...
      a: `Yes. Membership is not sold on the public house. An invitation is issued when there is a seat. ${capLineLong(seats.cap)}`,
    },
  ];
