...
export const CONTINENTAL_STATE_CODES = CONTINENTAL_STATES.map((state) => state.code);

export const EXCLUDED_US_REGIONS = [
  "Alaska",
  "Hawaii",
  "Puerto Rico",
  "Guam",
...
export function isContinentalState(code: string) {
